...
`NEXT_PUBLIC_ADSENSE_CLIENT_ID`와 `NEXT_PUBLIC_ADSENSE_DISPLAY_SLOT`에는 본인 웹 AdSense 광고 계정의 실제 값을 사용하세요. Android AdMob 데모 보상 광고 단위 `5224354917`은 웹 AdSense 슬롯이 아닙니다. 현재 웹 광고 표시와 크레딧 보상은 연결되지 않습니다.
