...
export const T: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    gen_reference_video: '참고 영상', gen_reference_trend: '트렌드 참고 영상', gen_view_source: '원본 영상 보기', gen_optional_label: '선택 사항', gen_url_placeholder_localized: '선택 사항: YouTube Shorts 또는 TikTok 링크', gen_create_plan: '영상 제작 플랜 만들기', gen_create_plan_cost: '크레딧 5개', gen_creating_plan: '영상 플랜 만드는 중...', gen_preparing: '준비 중...', gen_analyzing_structure: '영상 구조 분석 중...', gen_analyzing_done: '영상 분석 완료', gen_progress_accessible: '대본 생성 진행률 {progress}%', gen_progress_message: '영상을 확인하고 구조를 분석한 뒤 대본을 생성합니다.',
  ...
  zh: {
    ...
    gen_reference_video: '参考视频', gen_reference_trend: '趋势参考视频', gen_view_source: '查看原视频', gen_optional_label: '可选', gen_url_placeholder_localized: '可选：YouTube Shorts 或 TikTok 链接', gen_create_plan: '创建视频方案', gen_create_plan_cost: '5 积分', gen_creating_plan: '正在创建视频方案…', gen_preparing: '准备中…', gen_analyzing_structure: '正在分析视频结构…', gen_analyzing_done: '视频分析完成', gen_progress_accessible: '脚本生成进度 {progress}%', gen_progress_message: '正在检查视频、分析结构并生成脚本。',
  ...
  ja: {
    ...
    gen_reference_video: '参考動画', gen_reference_trend: 'トレンド参考動画', gen_view_source: '元動画を見る', gen_optional_label: '任意', gen_url_placeholder_localized: '任意：YouTube Shorts または TikTok のリンク', gen_create_plan: '動画プランを作成', gen_create_plan_cost: '5クレジット', gen_creating_plan: '動画プランを作成中…', gen_preparing: '準備中…', gen_analyzing_structure: '動画構成を分析中…', gen_analyzing_done: '動画分析が完了しました', gen_progress_accessible: '台本生成の進捗 {progress}%', gen_progress_message: '動画を確認して構成を分析し、台本を生成します。',
