...
export const T: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    trend_filter_all: '전체',
    trend_no_data: '아직 트렌드 데이터가 없습니다 · Cron이 첫 실행될 때까지 기다려주세요',
    ...
    gen_expand: '더보기',
    gen_collapse: '접기',
    gen_login_required: '분석하려면 로그인이 필요합니다',
    gen_login_desc: '대본 생성을 사용하려면 로그인 또는 회원가입을 해주세요.',
    gen_login_btn: '로그인하고 분석하기',
  ...
  en: {
    ...
    gen_login_required: 'Login required to analyze',
    gen_login_desc: 'Please log in or sign up to use the script generator.',
    gen_login_btn: 'Log In & Analyze',
  ...
  zh: {
    ...
    gen_expand: '展开',
    gen_collapse: '收起',
    gen_login_required: '需要登录才能分析',
    gen_login_desc: '请登录或注册以使用脚本生成器。',
    gen_login_btn: '登录并分析',
  ...
  ja: {
    ...
    gen_expand: 'もっと見る',
    gen_collapse: '折りたたむ',
    gen_login_required: '分析するにはログインが必要です',
    gen_login_desc: '脚本ジェネレーターを使用するにはログインまたは会員登録してください。',
    gen_login_btn: 'ログインして分析',
